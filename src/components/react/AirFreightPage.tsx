  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-sky-900 via-sky-800 to-blue-900 py-20 lg:py-28">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <a href="/services" className="inline-flex items-center gap-2 text-sky-300 hover:text-white text-sm font-medium mb-8 transition-colors">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="/services/customs-documents"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                <a href="/services/customs-documents" className="text-sky-700 font-medium underline-offset-2 hover:underline">
                  customs & documents
                </a>{" "}
